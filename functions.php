...
function custom_locummeds_scripts() {
	...
	wp_enqueue_style( 'custom-locummeds-font', 'https://fonts.googleapis.com/css?family=Asap:400,700|Montserrat:300,400,600&display=swa' );
	wp_enqueue_style( 'font-awesome', 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' );
	wp_enqueue_style( 'owl-style', get_template_directory_uri() . '/js/owl/owl.carousel.min.css' );

	wp_enqueue_script( 'locummeds-child-script', get_stylesheet_directory_uri() . '/js/bundle.js', false, true );
